...
`apply`, `c`, `clear`, `clc`, `concath`, `concatv`, `copy`, `cross`, 
`det`, `diag`, `disp`, `display`, `dot`, `expand`, `eye`, `flatten`,  `flipfr`, `flipud`,
...
#### a. Mathly 'creator', `concath`, `concatv`, `diag`, `expand`, `flipfr`, `flipud`, `ones`, `zeros`, `rand`, `randi`, `reshape`, `submatrix`, `c`, `r`, and matrix operations can generate mathly matrices.
```Lua
