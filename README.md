...
hardly install them on pretty old computers and run smoothly. In fact, running these products on new laptops, we often hate that 
they are not as powerful as advanced desktop computers.
