...
#### a. Mathly 'creator', `concath`, `concatv`, `diag`, `expand`, `flipfr`, `flipud`, `lu`, `ones`, `zeros`, `rand`, `randi`, `reshape`, `submatrix`, `c`, `r`, and matrix operations can generate mathly matrices.
```Lua
