...
-- generated by https://github.com/fdformula/MathlyLua/examples/gauss_quadrature_by_legendre_polynomial.lua
local _Gw = {
...
local function _write_manipulate_html(fname, cs, rs, xr, yr, tr, title, xexpr, yexpr, jxexpr, jyexpr, enhancements, jscode, opts)
  ...
  local s = [[<!DOCTYPE html><!-- generated by Lua + Mathly: https://github.com/fdformula/MathlyLua -->
<html>
<head>
 <meta charset="utf-8">
